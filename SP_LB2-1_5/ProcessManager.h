...
#define IDM_PROCESS_TESTPROC 1005        // Новая команда для TestProc
#define IDM_PROCESS_NOTEPAD_WAIT 1006    // Новая команда для блокнота с ожиданием
...
#define IDD_SELECT_FILE 3002             // Новое диалоговое окно выбора файла
...
extern HANDLE ProcHandle[5];            // Массив дескрипторов процессов
extern DWORD ProcId[5];                 // Массив идентификаторов процессов (PID)
extern HANDLE ThreadHandle[5];          // Массив дескрипторов основных потоков
extern DWORD ThreadId[5];               // Массив идентификаторов потоков (TID)
extern LPTSTR ProcImage[5];             // Массив путей к исполняемым файлам
extern TCHAR CmdParam[5][260];          // Массив параметров командной строки
...
BOOL RunNotepadAndWait(LPCTSTR filename);  // Новая функция
void DisplayFileContent(LPCTSTR filename); // Новая функция
